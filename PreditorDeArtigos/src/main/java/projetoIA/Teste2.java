...
public class Teste2 {
		...
		public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException {
			...
			try {
				...
				int totalDeNeuronios = (int) Math.round((FEATURES_COUNT + CLASSES_COUNT)/4);
				...
				MultiLayerConfiguration configuration 
				  = new NeuralNetConfiguration.Builder()
				    ...
				    .iterations(10000) // Epocas de treino
...
//				    .layer(4, new DenseLayer.Builder().nIn(totalDeNeuronios).nOut(totalDeNeuronios).build())
...
//				INDArray result = model.output(input);
				...
				//Save the model
		        File locationToSave = new File("C:\\projeto_ia\\base\\MyMultiLayerNetwork.zip");      //Where to save the network. Note: the file is in .zip format - can be opened externally
